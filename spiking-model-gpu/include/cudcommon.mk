...
LIBDIR     := $(ROOTDIR)/../../lib
COMMONDIR  := $(HOME)/NVIDIA_CUDA_SDK/common
...
# Includes
INCLUDES  += -I. -I$(CUDA_INSTALL_PATH)/include -I$(COMMONDIR)/inc -I$(ROOTDIR)/../../inc -I$(ROOTDIR)/../inc
...
# Libs
LIB       := -L$(CUDA_INSTALL_PATH)/lib -L$(LIBDIR) -L$(LIBDIR)/$(LIBSUBDIR) -L$(COMMONDIR)/lib/$(OSLOWER)
ifeq ($(USEDRVAPI),1)
...
LIB += -lepconfig -lepcommon -lepsocket -lepthread -lexpatobject
LIB += -lpthread
LIB += -lIL
EXPATOBJS := ../../expat-1.95.8/lib/xmlparse.o ../../expat-1.95.8/lib/xmlrole.o ../../expat-1.95.8/lib/xmltok.o

# Lib/exe configuration
ifneq ($(STATIC_LIB),)
	TARGETDIR := $(LIBDIR)
	TARGET   := $(subst .a,$(LIBSUFFIX).a,$(LIBDIR)/$(STATIC_LIB))
	LINKLINE  = ar qv $(TARGET) $(OBJS) $(EXPATOBJS) 
else
	...
	LINKLINE  = $(LINK) -o $(TARGET) $(OBJS) $(EXPATOBJS) $(LIB)
endif
